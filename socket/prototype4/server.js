...
socket.on('message', (msg, rinfo) => {
  console.log(`msg received: ${msg} from ${rinfo.address}:${rinfo.port}`);
...
socket.bind(multicastPort, () => {
  console.log(`UDP socket on port ${multicastPort} for multicast messages`);
});
// Serve HTML page
app.get('/', (req, res) => {
...
//     udpSocket.send(msg, 0, msg.length, multicastPort, multicastAddress, () => {
      
//       console.log('sent UDP multicast:', msg);
//     });
//   });
